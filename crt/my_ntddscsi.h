...
// SPTI structures MUST be DWORD aligned for DeviceIOControl function OR it WILL fail!
#pragma pack(4) 
//
...
typedef struct _IO_SCSI_CAPABILITIES {
    ...
    ULONG MaximumTransferLength; // Maximum transfer size in single SRB
...
#define SCSI_IOCTL_SENDING_DATA_TO_DEVICE  0

#define SCSI_IOCTL_DATA_IN           1
#define SCSI_IOCTL_GETTING_DATA_FROM_DEVICE 1
